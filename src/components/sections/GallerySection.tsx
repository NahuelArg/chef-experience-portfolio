...
const GallerySection: React.FC = () => {
  ...
  return (
    <section className="w-full min-h-screen bg-white flex flex-col justify-between px-4 md:px-8 lg:px-12 py-8">
      ...
      <div className="flex flex-col md:flex-row md:gap-8 items-center">
        ...
        <div
          className="md:w-1/3 mt-6 md:mt-0 text-center md:text-left"
