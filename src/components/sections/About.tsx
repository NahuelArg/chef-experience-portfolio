...
const About: React.FC = () => {
  ...
  return (
<section className="w-full flex items-start justify-center  px-2 pt-4 sm:px-4 md:px-8 md:pt-8">
  <div className="max-w-7xl mx-auto w-full">
    ...
    <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center md:items-start">
      ...
      <div className="flex-1 space-y-4 w-full max-w-full mt-0 md:max-h-none pr-1">
        <div className="w-full flex justify-center mb-1 md:hidden">
          <span className="flex items-center gap-1 text-black-400 text-xs animate-bounce">
            {t("swipe")}</span>
        </div>
